...
namespace AlphaApp
{
    class Program
    {
        static void Main(string[] args)
        {
         ...
         // Program to notify the subscribers to renew their subscription.
        ...
        /* Random random = new Random();
         ...
         Console.WriteLine("Enter your number for its multiplication table:");
         ...
         string phoneNumber = "09074866640";
         foreach(var digits in phoneNumber)
         {
          //int.Parse(digits);
         ...
         int x1 = 0 ,y1 = 0;
         bool isInsideAndOutOfRectangle = false;
         ...
         isInsideAndOutOfRectangle = isInsideTheCircle && outOfRectangle;
         }
         catch (Exception ex)
         {
